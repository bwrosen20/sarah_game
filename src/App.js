...
function App() {
  ...
  {"index":6,"item":"Nature", "price":cookies.mainStoreItems[30], "clicks":cookies.mainStoreItems[31], "amount":cookies.mainStoreItems[32], "picture":nature, "visible":cookies.mainStoreItems[33],"extra":cookies.mainStoreItems[34]},
...
//index 8 is actually 128
  ...
  useEffect(()=>{
    const autoClicker = setTimeout(()=>{
        ...
        if (cookieCounter==10){
          console.log("Hi")
          setCookie('everything', [clicks,goldenSmile,thousandFingersCount,lucky,clickValue,autoClicks,clicksSoFar,soFar], { path: '/' }, { expires: expirationDate })
          ...
          setCookie('upgrades_three', [upgrades[199]["visible"],upgrades[200]["visible"],upgrades[201]["visible"],upgrades[202]["visible"],upgrades[203]["visible"],upgrades[204]["visible"]],{path: '/'}, { expires: expirationDate })
        ...
        <StoreItemsContext.Provider value={mainStoreItems}>
          ...
          <h2 className="userTitle">Sarah Smiler</h2>
            ...
            <img src={statistics} alt="stats" className="statistics" onClick={openStatisticsFunc}/>
              {openSettings ? <Settings/>:openStatistics ? <Statistics upgrades={upgrades} clicksSoFar={clicksSoFar} soFar={soFar} clicks={clicks}/>:<AutomatedClicks />}
